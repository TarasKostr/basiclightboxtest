...
const createItemMarkup = array => (
    galleryList.innerHTML = array.map(({preview, original, description}) => `<li class="gallery__item">
...
function openModalClick (event) {
    ...
    instance = basicLightbox.create(`
        <div class="modal">
            <img src="${originImageSrc}" alt="">
        </div>
    `)

    instance.show()
}
createItemMarkup(galleryItems)
